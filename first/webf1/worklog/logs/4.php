<?php
	...
	$text = createImage('img/Text2MindMap.png', 'Mindmap', 'right')
		  ...
		  . "It also means you can make more natural notes instead of trying to format them as you take them.</p>"
  		  . "<p>I had already done two on paper but then I created one using the website " . createLink('http://www.text2mindmap.com/grddRA', 'Text2Mindmap', 'Text2Mindmap') . " (see image above).</p>"
