...
CREATE TABLE ConsultantSpecialism (
	CONSULTANTSPECIALISM_ID INT NOT NULL,
	CONSULTANTSPECIALISM_NAME VARCHAR(20) NOT NULL,
	PRIMARY KEY (CONSULTANTSPECIALISM_ID)
);
...
CREATE TABLE Consultant (
	...
	PRIMARY KEY (STAFF_ID),
	FOREIGN KEY (WARD_ID) REFERENCES Ward(WARD_ID),
	FOREIGN KEY (CONSULTANTSPECIALISM_ID) REFERENCES ConsultantSpecialism(CONSULTANTSPECIALISM_ID)
);
