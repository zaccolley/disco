...
disp(sprintf('          ___________\n  ~  ~~~ // --|||-- \\\\   \n ~~~~ __//____|||____\\\\____   \n   ~  | _|    " | "   --_  || \n  ~~~ |/ \\______|______/ \\_|| \n ______\\_/_____________\\_/_______     =~+ UP665219 AGAV TASK TWO +~='))
...
% fire01.jpg - fire02.jpg (speeding, red, normal width)

name = 'Fire engine';
[red, speedResult, speed, width, size] = calc(strcat(inPath, 'fire01.jpg'), strcat(inPath, 'fire02.jpg'));
fprintf('│ %16s │ %8s │ %16s (%6.2f) │ %12s (%4.2f) │\n', name, red, speedResult, speed, size, width)

% oversize.jpg - oversize.jpg (normal, blue, oversized width)
...
disp('└──────────────────┴──────────┴────────────────────────────┴─────────────────────┘')
disp('   :¬)                                          Special thanks to Dr. Tan x0x0x   ')
