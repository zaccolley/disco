<?php
	...
	$text = "<p>Lecture included information about the different " . createAbbr('HTML', 'HyperText Markup Language') . " version which was informative. "
			  ...
			  . "it doesn't seem practical in a work environment as supporting some of the lesser browsers (e.g " . createAbbr('IE6', 'Internet Explorer 6') . ") can unfortunately be a specification by a client. "
